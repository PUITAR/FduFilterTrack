                                                    ...
                                                    const int32_t& label1, const int32_t& label2, IDType *indices, float *distances)
{
    ...
    return _search(any_query, K, L, threshold_1, threshold_2, label1, label2, any_indices, distances);
}
...
{
    auto any_indices = std::any(indices);
    return _search_with_filters(query, raw_label, K, L, any_indices, distances, best_method, threshold_1, threshold_2);
}
...
template DISKANN_DLLEXPORT std::pair<uint32_t, uint32_t> AbstractIndex::search<float, uint32_t>(const float *query, const size_t& K, const uint32_t& L, 
                                                                                                const uint32_t& threshold_1, const uint32_t& threshold_2, 
                                                                                                const int32_t& label1, const int32_t& label2, uint32_t *indices, float *distances);
template DISKANN_DLLEXPORT std::pair<uint32_t, uint32_t> AbstractIndex::search<uint8_t, uint32_t>(const uint8_t *query, const size_t& K, const uint32_t& L, 
                                                                                                const uint32_t& threshold_1, const uint32_t& threshold_2, 
                                                                                                const int32_t& label1, const int32_t& label2, uint32_t *indices, float *distances);
template DISKANN_DLLEXPORT std::pair<uint32_t, uint32_t> AbstractIndex::search<int8_t, uint32_t>(const int8_t *query, const size_t& K, const uint32_t& L, 
                                                                                                const uint32_t& threshold_1, const uint32_t& threshold_2, 
                                                                                                const int32_t& label1, const int32_t& label2, uint32_t *indices, float *distances);

template DISKANN_DLLEXPORT std::pair<uint32_t, uint32_t> AbstractIndex::search<float, uint64_t>(const float *query, const size_t& K, const uint32_t& L, 
                                                                                                const uint32_t& threshold_1, const uint32_t& threshold_2, 
                                                                                                const int32_t& label1, const int32_t& label2, uint64_t *indices, float *distances);
template DISKANN_DLLEXPORT std::pair<uint32_t, uint32_t> AbstractIndex::search<uint8_t, uint64_t>(const uint8_t *query, const size_t& K, const uint32_t& L, 
                                                                                                const uint32_t& threshold_1, const uint32_t& threshold_2, 
                                                                                                const int32_t& label1, const int32_t& label2, uint64_t *indices, float *distances);
template DISKANN_DLLEXPORT std::pair<uint32_t, uint32_t> AbstractIndex::search<int8_t, uint64_t>(const int8_t *query, const size_t& K, const uint32_t& L, 
                                                                                                const uint32_t& threshold_1, const uint32_t& threshold_2, 
                                                                                                const int32_t& label1, const int32_t& label2, uint64_t *indices, float *distances);
