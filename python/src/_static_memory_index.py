...
class StaticMemoryIndex:
    def __init__(
        ...
        elif vector_dtype == np.ubyte or vector_dtype == np.uint8:
    ...
    def batch_search(
        self, queries: VectorLikeBatch, k_neighbors: int, complexity: int, num_threads: int, query_filters_offset: VectorLikeBatch, query_filters_data: VectorLikeBatch, threshold_1: int, threshold_2: int
    ) -> QueryResponseBatch:
        """
        ...
        return self._index.batch_search(
            ...
            num_threads=num_threads,
            query_filters_offset=query_filters_offset,
            query_filters_data=query_filters_data,
