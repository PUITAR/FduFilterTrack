...
class StaticMemoryIndex
{
  public:
    ...
    NeighborsAndDistances<StaticIdType> batch_search(py::array_t<DT, py::array::c_style | py::array::forcecast> &queries,
                                           uint64_t num_queries, uint64_t knn, uint64_t complexity, uint32_t num_threads, py::array_t<int, py::array::c_style | py::array::forcecast> query_filters_offset, py::array_t<int, py::array::c_style | py::array::forcecast> query_filters_data, uint32_t threshold_1, uint32_t threshold_2);
  private:
